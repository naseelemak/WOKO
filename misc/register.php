                ...
                <form id="regForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" name="regPass" class="form-control" id="regPass" placeholder="Password" minlength="6" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="regCPass">Confirm Password</label>
                            <input type="password" name="regCPass" class="form-control" id="regCPass" equalto="#regPass" placeholder="Password" minlength="6" required>
                        </div>
                    </div>
