...
<div class="container mt-3 mb-5">
    ...
    <form id="contactForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="form-group">
            ...
            <textarea id="message" name="message" class="form-control" rows="7" placeholder="E.g. We're organising a hackathon in February and would like to invite the students of APU to participate in it. You can read more about the event here – https://www.hackyhacky2018.com. We look forward to your involvement!"></textarea>
        </div>
