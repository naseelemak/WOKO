        ...
        <div class="col-md-8">
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    ...
                    <p>No email received? Click <a href="confirm-mailer.php?id=<?php $_SESSION['previous_location'] = "confirmation"; echo $_GET['id']; ?>" target="_blank">here</a> to resend confirmation email...</p>
