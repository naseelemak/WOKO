...
?>
    ...
    <div class="container">
        <div class="row px-2">
            <div class="col-md-12">
                <form id="compEditForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" maxlength="250" type="text" name="compDesc" id="compDesc" class="form-control mb-3" placeholder="250 Characters Max" required><?php echo $row['short_desc']; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="compVenue" id="compVenue" class="form-control mb-3" value="<?php echo $row['venue']; ?>" placeholder="E.g. Mid Valley" required>
                    </div>

                    <!-- Registration Fee -->
                    <div class="form-group">
                        <label for="compFee">Registration Fee (MYR)</label>
                        <input type="number" name="compFee" id="compFee" class="form-control mb-3" min="0" value="<?php echo $row['fee']; ?>" placeholder="Per individual / team" required>
                    </div>
